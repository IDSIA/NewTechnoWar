...
def computeSaliencyUsingIyer(original_action, dict_q_vals_before_perturbation, dict_q_vals_after_perturbation):
    ...
    answer=q_value_action_original_state-q_value_action_perturbed_state
    return(answer)
