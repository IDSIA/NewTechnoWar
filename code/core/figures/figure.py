...
class Figure:
    ...
    def __init__(self, position: tuple or Cube, name: str, team: str, kind: str, status: FigureStatus = None):
        ...
        self.stat: FigureStatus = status if status else status
        self.bonus = 0
...
class Tank(Figure):
    ...
    def __init__(self, position: tuple, team: str, name: str = 'Tank', status: FigureStatus = None):
        super().__init__(position, name, team, 'vehicle', status)
        self.move = 7
        self.load = 1
        self.hp = 1
        self.hp_max = 1
...
class Infantry(Figure):
    ...
    def __init__(self, position: tuple, team: str, name: str = 'Infantry', status: FigureStatus = None):
        super().__init__(position, name, team, 'infantry', status)
        self.move = 4
        self.load = 1
        self.hp = 4
        self.hp_max = 4
